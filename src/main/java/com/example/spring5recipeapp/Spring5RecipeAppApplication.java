...
//   @Bean
//    public CommandLineRunner dataLoader(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
//        return args -> {
...
//            unitOfMeasure7.setDescription("Dash");
...
//    @Bean
//    public CommandLineRunner getRecipes(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository){
//        return args -> {
//            Category category = new Category();
//            category.setDescription("American");
//            categoryRepository.save(category);
...
//            unitOfMeasureRepository.save(unitOfMeasure8);
//
//            System.out.println(unitOfMeasureRepository.findByDescription("Each").get().getId() + " " + unitOfMeasureRepository.findByDescription("Each").get().getDescription()+
//                    "-------------------------------------test");
...
//
//            System.out.println(eachUomOptional.get().getId()+ "--------------------------------test");
//
